...
Coin::Coin(visuals::ShaderProgram& i_shaderProgram, const glm::ivec2& i_tileMapDisplay, CoinType i_type)
	: BreakableBlock(1,std::make_unique<visuals::Sprite>(glm::vec2(32, 32), glm::vec2(1, 1), s_coinPaths.at(i_type), visuals::PixelFormat::TEXTURE_PIXEL_FORMAT_RGB, i_shaderProgram), i_tileMapDisplay)
{
