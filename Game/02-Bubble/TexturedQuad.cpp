...
namespace game
{
	namespace gui
	{
		TexturedQuad *TexturedQuad::createTexturedQuad(glm::vec2 geom[2], glm::vec2 texCoords[2], visuals::ShaderProgram &program)
		{
		...
		TexturedQuad::TexturedQuad(glm::vec2 geom[2], glm::vec2 texCoords[2], visuals::ShaderProgram &program)
		{
		...
		void TexturedQuad::render(const visuals::Texture &tex) const
		{
